...
import {IOtterSwapPoolImmutables, IOtterSwapPoolState, IOtterSwapPoolActions, IOtterSwapPoolDerivedState, IOtterSwapPoolOwnerActions, IOtterSwapPool} from './interfaces/IOtterSwapPool.sol';
...
import {IOtterSwapFactory} from './interfaces/IOtterSwapFactory.sol';
import {IERC20Minimal} from './interfaces/IERC20Minimal.sol';
import {IOtterSwapMintCallback} from './interfaces/callback/IOtterSwapMintCallback.sol';
import {IOtterSwapSwapCallback} from './interfaces/callback/IOtterSwapSwapCallback.sol';
import {IOtterSwapFlashCallback} from './interfaces/callback/IOtterSwapFlashCallback.sol';

contract OtterSwapPool is IOtterSwapPool, NoDelegateCall {
    ...
    /// @inheritdoc IOtterSwapPoolImmutables
    ...
    /// @inheritdoc IOtterSwapPoolState
    ...
    /// @dev Prevents calling a function from anyone except the address returned by IOtterSwapFactory#owner()
    modifier onlyFactoryOwner() {
        require(msg.sender == IOtterSwapFactory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = IOtterSwapPoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc IOtterSwapPoolDerivedState
    ...
    /// @inheritdoc IOtterSwapPoolActions
    ...
    function mint(
        ...
        IOtterSwapMintCallback(msg.sender).otterswapMintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            IOtterSwapSwapCallback(msg.sender).otterswapSwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        IOtterSwapFlashCallback(msg.sender).otterswapFlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc IOtterSwapPoolOwnerActions
