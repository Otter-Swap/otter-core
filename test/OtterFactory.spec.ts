...
describe('OtterSwapFactory', () => {
  ...
  const fixture = async () => {
    ...
    return (await factoryFactory.deploy()) as OtterSwapFactory
  }
  ...
  before('load pool bytecode', async () => {
    poolBytecode = (await ethers.getContractFactory('OtterSwapPool')).bytecode
  })
  ...
  async function createAndCheckPool(
    ...
    const poolContractFactory = await ethers.getContractFactory('OtterSwapPool')
