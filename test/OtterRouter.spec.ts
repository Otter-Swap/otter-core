...
describe('OtterSwapPool', () => {
  ...
  let pool0: MockTimeOtterSwapPool
  let pool1: MockTimeOtterSwapPool
  ...
  let swapTargetCallee: TestOtterSwapCallee
  let swapTargetRouter: TestOtterSwapRouter
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeOtterSwapPool, any]> => {
